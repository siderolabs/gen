...
#
# Generated on 2026-09-10T14:33:36Z by kres 3e1d3c0.
...
RUN --mount=type=cache,target=/root/.cache/go-build,id=gen/root/.cache/go-build --mount=type=cache,target=/go/pkg,id=gen/go/pkg go install github.com/shanduur/dis-vulncheck@${DIS_VULNCHECK_VERSION} \
...
WORKDIR /src
RUN --mount=type=cache,target=/root/.cache/go-build,id=gen/root/.cache/go-build --mount=type=cache,target=/go/pkg,id=gen/go/pkg dis-vulncheck -tool=false ./...
